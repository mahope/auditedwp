...
';
    ...
    private static function signatures( $group ) {
        $sets = array(
            ...
            'cmv2'     => array(
                array( 'name' => 'Google Consent Mode v2 class/attribute', 're' => '~google_consent_mode|consent_mode_v2|cmv2[\s_,]~i' ),
                array( 'name' => 'Google Consent Mode v2 (gtag)', 're' => '~gtag\([\'"]consent[\'"]|[\'"]consent[\'"],\s*[\'"]default[\'"]|consent.*default.*ad_storage|ad_storage.*consent~i' ),
                array( 'name' => 'Google Consent Mode v2 (dataLayer)', 're' => '~dataLayer[\s\S]{0,200}consent[\s\S]{0,200}(default|update)~i' ),
                array( 'name' => 'Consent signals for ad storage and personalization', 're' => '~granted|denied[\s\S]{0,40}ad_storage|ad_storage[\s\S]{0,40}(granted|denied)~i' ),
                array( 'name' => 'Google Ads consent integration', 're' => '~google_ads[\s\S]{0,100}consent|consent[\s\S]{0,100}google_ads~i' ),
                array( 'name' => 'Analytics storage consent signal', 're' => '~consent.*analytics_storage|analytics_storage.*consent~i' ),
            ),
            // IAB Transparency & Consent Framework.
            'tcf'      => array(
                array( 'name' => 'IAB TCF API (__tcfapi)', 're' => '~__tcfapi|tcfapi~i' ),
                array( 'name' => 'IAB TCF cookies set', 're' => '~IABTCF_[a-z]~i' ),
                array( 'name' => 'GDPR applies / TCF GDPR signals', 're' => '~gdprApplies|tcf[_-]?gdpr~i' ),
                array( 'name' => 'IAB Consent String present', 're' => '~IAB[_-]?Consent[_-]?String|tcstring|consent[_-]?string[_-]?tcf~i' ),
            ...
            'consent'  => array(
                array( 'name' => 'Cookiebot / OneTrust / Usercentrics / ConsentManager', 're' => '~cookiebot|consentmanager|onetrust|usercentrics~i' ),
                ...
                array( 'name' => 'Generic cookie consent banner', 're' => '~cookie[_-]?notice|gdpr[_-]?banner|eu[_-]?cookie~i' ),
                array( 'name' => 'Axeptio', 're' => '~axeptio~i' ),
                array( 'name' => 'CookieScript', 're' => '~cookiescript~i' ),
                ...
                array( 'name' => 'CEE/PL consent plugin', 're' => '~shoper|shoprenter|idelo~i' ),
                array( 'name' => 'WP Consent API', 're' => '~wp-consent-api~i' ),
                array( 'name' => 'Borlabs / CookieNinja', 're' => '~borlabs|cookieninja~i' ),
