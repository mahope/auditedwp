...
Sidste iteration: færdig — verificeret offentligt deploy-træ på `ceo/deploy-hygiene`, commit `317e382`
Baseline: `main` commit `db4ad80` efter `git pull --ff-only` 2026-09-25
